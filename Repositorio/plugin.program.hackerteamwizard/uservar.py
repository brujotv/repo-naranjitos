...
ADDONTITLE     = '[COLOR white]**[COLOR aqua][B]HackerTeam Wizard[/B][COLOR white]**[/COLOR]'
BUILDERNAME    = 'HackerTeam WIZARD'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, 'plugin.program.HackerWizardTeam', 'My_Builds', 'backupdir']
...
ADVANCEDFILE   = 'http://tvbox.uiwap.com/kodi/Advanced.txt'
ROMPACK        = 'http://tvbox.uiwap.com/kodi/rom-packs.txt'
EMUAPKS        = 'http://'
ADDONPACK      = 'http://'
...
ICONBUILDS     = 'http://tvbox.uiwap.com/kodi/Icon.ong'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing HackerTeam Wizard.\r\n\r\nContact us on facebook or Twitter and Telegram '
...
NOTIFICATION   = 'http://tvbox.uiwap.com/kodi/notification.txt'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font13'
HEADERMESSAGE  = 'HackerTeam Wizard'
# url to image if using Image 424x180
HEADERIMAGE    = ''
# Font for Notification Window
FONTSETTINGS   = 'Font12'
# Background for Notification Window
BACKGROUND     = 'http://tvbox.uiwap.com/kodi/back.png'
############################    #############################